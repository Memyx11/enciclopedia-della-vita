            ...
            <div className="landing-container">
                ...
                <section className="features-section">
                    <div className="feature-card">
                        ...
                        <p>Connette i puntini che tu non vedi. Sonno, energia, relazioni - tutto collegato.</p>
                    </div>
                    <div className="feature-card">
                        <div className="feature-icon">💬</div>
                        <h3>Parla con te</h3>
                        <p>Non comandi. Conversazioni vere che costruiscono la tua dashboard.</p>
                    </div>
                    <div className="feature-card">
                        <div className="feature-icon">🚀</div>
                        <h3>Ti sfida</h3>
                        <p>Non ti asseconda. Ti spinge a diventare la versione migliore di te.</p>
                    </div>
                </section>
            </div>
        )
            ...
            <main className="universe-main">
                ...
                <div className="quick-insight">
                    ...
                    <p className="insight-text">
                        Clicca su un&apos;area per esplorare il tuo viaggio.
                    </p>
                </div>
            </main>
